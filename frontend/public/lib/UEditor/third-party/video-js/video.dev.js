...
vjs.Player.prototype.exitFullWindow = function(){
  ...
  // Resize the box, controllers, and poster to original sizes
  // this.positionAll();
...
// controllers: function(){ return this.techCall('controllers'); },
 ...
 * @type {String}
 */
vjs.media.ApiMethods = 'play,pause,paused,currentTime,setCurrentTime,duration,buffered,volume,setVolume,muted,setMuted,width,height,supportsFullScreen,enterFullScreen,src,load,currentSrc,preload,setPreload,autoplay,setAutoplay,loop,setLoop,error,networkState,readyState,seeking,initialTime,startOffsetTime,played,seekable,ended,videoTracks,audioTracks,videoWidth,videoHeight,textTracks,defaultPlaybackRate,playbackRate,mediaGroup,controllers,controls,defaultMuted'.split(',');
...
var api = vjs.Flash.prototype,
    readWrite = 'rtmpConnection,rtmpStream,preload,currentTime,defaultPlaybackRate,playbackRate,autoplay,loop,mediaGroup,controllers,controls,volume,muted,defaultMuted'.split(','),
