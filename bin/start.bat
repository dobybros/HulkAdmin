set JAR_NAME=hulkadmin.jar
set xmx64=300m
set xms64=300m
set G1NewSizePercent=20
...
set JAVA_MEM_OPTS= -server -Xmx%xmx64% -Xms%xms64% -XX:+UseG1GC -XX:+UnlockExperimentalVMOptions -XX:G1NewSizePercent=%G1NewSizePercent% -XX:G1MaxNewSizePercent=%G1MaxNewSizePercent% -XX:MaxGCPauseMillis=%MaxGCPauseMillis% -Djava.awt.headless=true
